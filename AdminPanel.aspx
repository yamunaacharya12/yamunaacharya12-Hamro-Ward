<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPanel.aspx.cs" Inherits="HamroWard.AdminPanel" %>
<!DOCTYPE html>
...
<head runat="server">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .table-toolbar { padding: 16px 20px; border-bottom: 1px solid #E2E8F0; display: flex; gap: 10px; align-items: center; flex-wrap: wrap; }
...
<nav id="sidebar">
    ...
    <div class="nav-section">
        ...
        <a class="nav-item" href="Applications.aspx">
            <span class="icon">📋</span> Applications
            <%-- Pending badge rendered from server --%>
            <asp:Label ID="lblPendingBadge" runat="server" CssClass="nav-badge">0</asp:Label>
        </a>
...
<div id="main">
    ...
    <header id="header">
        ...
        <div class="header-right">
            ...
            <button type="button" class="notif-btn" onclick="toggleModal('notifModal')">
    ...
    <div id="content">
        ...
        <div class="table-card">
            ...
            <div class="table-toolbar">
                ...
                <asp:DropDownList ID="ddlServiceFilter" runat="server" CssClass="filter-select"
                    AutoPostBack="true" OnSelectedIndexChanged="DdlService_Changed">
            ...
            <asp:GridView ID="gvApplications" runat="server"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Actions">
                        <ItemTemplate>
                            <asp:LinkButton runat="server" CommandName="ApproveApp"
                                CommandArgument='<%# Eval("ApplicationID") %>'
                                CssClass="action-btn btn-approve">✓ Approve</asp:LinkButton>
                            <asp:LinkButton runat="server" CommandName="RejectApp"
                                CommandArgument='<%# Eval("ApplicationID") %>'
                                CssClass="action-btn btn-reject">✗ Reject</asp:LinkButton>
                            <asp:LinkButton runat="server" CommandName="ViewApp"
                                CommandArgument='<%# Eval("ApplicationID") %>'
                                CssClass="action-btn btn-view">👁 View</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
...
function exportCSV() {
    ...
    rows.forEach(function (r) {
        ...
        var row = Array.from(cells).map(function (c) { return '"' + c.innerText.replace(/"/g, '""') + '"'; });
        csv.push(row.join(','));
    });
