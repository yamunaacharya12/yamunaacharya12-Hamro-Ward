<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="Migration.aspx.cs" Inherits="HamroWard.MigrationRegistration.Migration" %>
...
<div class="page-hero">
    <div class="hero-inner">
        ...
        <div class="hero-text">
            <h1>Migration Registration &nbsp;/&nbsp; बसाइसराइ दर्ता</h1>
...
<main style="max-width:1200px; margin:0 auto; padding:0 16px;">
    ...
    <nav class="breadcrumb-wrap">
        ...
        <span>Migration Registration</span>
    </nav>

    <div class="section-intro">
        <h2>Select a Migration Service &nbsp;/&nbsp; बसाइसराइ सेवा छान्नुहोस्</h2>
    </div>

    <div class="service-grid">

        <a href="~/MigrationRegistration/MigrationIn.aspx" runat="server" class="service-card">
            <div class="service-icon">🚚</div>
            <div>
                <p class="service-title">Migration In</p>
                <p class="service-title-nep">बसाइसराइ आएको</p>
            </div>
            <span class="service-badge">Incoming</span>
        </a>

        <a href="~/MigrationRegistration/MigrationOut.aspx" runat="server" class="service-card">
            <div class="service-icon">📦</div>
            <div>
                <p class="service-title">Migration Out</p>
                <p class="service-title-nep">बसाइसराइ गएको</p>
            </div>
            <span class="service-badge badge-warning">Outgoing</span>
        </a>

        <a href="~/MigrationRegistration/MigrationStatus.aspx" runat="server" class="service-card">
            <div class="service-icon">🔍</div>
            <div>
        ...
        <a href="~/MigrationRegistration/MigrationCertificate.aspx" runat="server" class="service-card">
            <div class="service-icon">📜</div>
            <div>
                <p class="service-title">Migration Certificate</p>
                <p class="service-title-nep">बसाइसराइ प्रमाणपत्र</p>
            </div>
            <span class="service-badge">Get Certificate</span>
        </a>
