<%@ Page Title="Birth Registration" Language="C#" MasterPageFile="~/home.Master"
    AutoEventWireup="true" CodeBehind="Birth.aspx.cs" Inherits="HamroWard.Birthregistration.Birth" %>
...
<div class="page-hero">
    <div class="hero-inner">
        ...
        <div class="hero-text">
            <h1>Birth Registration &nbsp;/&nbsp; जन्मदर्ता</h1>
...
<main style="max-width:1200px; margin:0 auto; padding:0 16px;">
    ...
    <div class="section-intro">
        <h2>Select a Birth Registration Service &nbsp;/&nbsp; जन्मदर्ता सेवा छान्नुहोस्</h2>
    </div>

    <div class="service-grid">

        <!-- 1. New Birth Registration -->
        <a href="/Birthregistration/BirthNew.aspx" class="service-card">
            <div class="service-icon">📋</div>
            <div>
                <p class="service-title">New Birth Registration</p>
                <p class="service-title-nep">नयाँ जन्मदर्ता दर्ता</p>
            </div>
            <span class="service-badge">New Application</span>
        </a>

        <!-- 2. Check Status -->
        <a href="/Birthregistration/BirthStatus.aspx" class="service-card">
            <div class="service-icon">🔍</div>
            <div>
        ...
        <!-- 3. Certified Copy -->
        <a href="/Birthregistration/BirthCopy.aspx" class="service-card">
            <div class="service-icon">📄</div>
            <div>
        ...
        <!-- 4. Correction -->
        <a href="/Birthregistration/BirthCorrection.aspx" class="service-card">
        ...
        <!-- 5. Late Registration -->
        <a href="/Birthregistration/BirthLate.aspx" class="service-card">
            <div class="service-icon">⏰</div>
            <div>
                <p class="service-title">Late Registration</p>
                <p class="service-title-nep">ढिलो जन्मदर्ता</p>
            </div>
            <span class="service-badge badge-warning">Late Entry</span>
        </a>

        <!-- 6. Transfer / Migration -->
        <a href="/Birthregistration/BirthTransfer.aspx" class="service-card">
            <div class="service-icon">🏘️</div>
            <div>
