<%@ Page Title="Check Birth Registration Status" Language="C#" MasterPageFile="~/home.Master"
    AutoEventWireup="true" CodeBehind="BirthStatus.aspx.cs" Inherits="HamroWard.Birthregistration.BirthStatus" %>
...
<style>
    ...
    .form-control { border:2px solid #e5e7eb !important; border-radius:12px !important; padding:11px 15px !important; font-size:0.97rem !important; background-color:#fafafa !important; }
...
<div class="page-hero">
    <div class="hero-inner">
        ...
        <div class="hero-text">
            <h1>Check Birth Registration Status &nbsp;/&nbsp; जन्मदर्ता स्थिति जाँच्नुहोस्</h1>
    ...
    <div class="row g-4 justify-content-center">
        <div class="col-lg-7">
            <div class="custom-card">
                <div class="card-header-custom"><h5>Enter Application Details &nbsp;/&nbsp; आवेदन विवरण दिनुहोस्</h5></div>
                <div class="card-body-custom">
                    <div class="mb-3">
                        <label class="form-label">Token / Application Number <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtTokenNo" runat="server" CssClass="form-control" placeholder="e.g. BIR-NEW-20810101120000" />
                    </div>
                    <div class="mb-4">
            ...
            <asp:Panel ID="pnlResult" runat="server" Visible="false">
                <div class="custom-card">
                    <div class="card-header-custom"><h5>Application Status &nbsp;/&nbsp; आवेदनको स्थिति</h5></div>
                    <div class="card-body-custom">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <div class="text-muted small">Child's Name</div>
                                <div class="fw-semibold"><asp:Label ID="lblChildName" runat="server" /></div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="timeline">
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="fw-semibold small">Under Review</div>
                                <div class="text-muted" style="font-size:0.8rem;"><asp:Label ID="lblStep2Date" runat="server" /></div>
                            </div>
                            <div class="timeline-item">
                                <div class="timeline-dot inactive"></div>
                                <div class="fw-semibold small">Approved / Ready to Collect</div>
