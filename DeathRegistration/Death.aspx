<%@ Page Title="Death Registration" Language="C#" MasterPageFile="~/home.Master"
    AutoEventWireup="true" CodeBehind="Death.aspx.cs"Inherits="HamroWard.DeathRegistration.Death" %>
...
<style>
    ...
    .section-intro p { color:#6b7280; font-size:0.97rem; max-width:560px; margin:0 auto; }
    .service-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(260px,1fr)); gap:24px; max-width:1100px; margin:0 auto 60px; padding:0 16px; }
    .service-card { background:white; border:2px solid #e8eaf0; border-radius:20px; padding:32px 28px; text-align:center; text-decoration:none; color:#1e2937; display:flex; flex-direction:column; align-items:center; gap:14px; box-shadow:0 4px 20px rgba(0,0,0,0.06); transition:all 0.25s ease; cursor:pointer; position:relative; overflow:hidden; }
    .service-card::after { content:''; position:absolute; bottom:0; left:0; right:0; height:4px; background:linear-gradient(90deg,var(--crimson),var(--navy)); transform:scaleX(0); transition:transform 0.25s ease; }
    .service-card:hover { border-color:var(--crimson); box-shadow:0 12px 40px rgba(220,20,60,0.14); transform:translateY(-4px); color:#1e2937; text-decoration:none; }
    .service-card:hover::after { transform:scaleX(1); }
    .service-icon { width:72px; height:72px; border-radius:50%; background:var(--crimson-light); display:flex; align-items:center; justify-content:center; font-size:2rem; transition:background 0.25s; }
    .service-card:hover .service-icon { background:linear-gradient(135deg,var(--crimson-light),var(--navy-light)); }
    .service-title { font-size:1.05rem; font-weight:700; color:#1e2937; margin:0; line-height:1.3; }
    .service-title-nep { font-size:0.82rem; color:var(--navy); font-weight:500; opacity:0.85; }
    .service-badge { font-size:0.72rem; font-weight:600; padding:3px 12px; border-radius:999px; background:var(--crimson-light); color:var(--crimson); }
    .service-badge.badge-info { background:var(--navy-light); color:var(--navy); }
    .service-badge.badge-warning { background:#fefce8; color:#92400e; }
    .service-badge.badge-danger { background:#fef2f2; color:#991b1b; }
</style>
...
<div class="page-hero">
    <div class="hero-inner">
        ...
        <div class="hero-text">
            <h1>Death Registration &nbsp;/&nbsp; मृत्युदर्ता</h1>
...
<main style="max-width:1200px; margin:0 auto; padding:0 16px;">
    ...
    <div class="section-intro">
        <h2>Select a Death Registration Service &nbsp;/&nbsp; मृत्युदर्ता सेवा छान्नुहोस्</h2>
    </div>

    <div class="service-grid">

        <!-- 1. New Death Registration -->
        <a href="/Deathregistration/DeathNew.aspx" class="service-card">
            <div class="service-icon">📋</div>
            <div>
                <p class="service-title">New Death Registration</p>
                <p class="service-title-nep">नयाँ मृत्युदर्ता दर्ता</p>
            </div>
            <span class="service-badge">New Application</span>
        </a>

        <!-- 2. Check Status -->
        <a href="/Deathregistration/DeathStatus.aspx" class="service-card">
            <div class="service-icon">🔍</div>
            <div>
        ...
        <!-- 3. Certified Copy -->
        <a href="/Deathregistration/DeathCopy.aspx" class="service-card">
            <div class="service-icon">📄</div>
            <div>
        ...
        <!-- 4. Correction -->
        <a href="/Deathregistration/DeathCorrection.aspx" class="service-card">
        ...
        <!-- 5. Late Registration -->
        <a href="/Deathregistration/DeathLate.aspx" class="service-card">
            <div class="service-icon">⏰</div>
            <div>
                <p class="service-title">Late Registration</p>
                <p class="service-title-nep">ढिलो मृत्युदर्ता</p>
            </div>
            <span class="service-badge badge-warning">Late Entry</span>
        </a>

        <!-- 6. Transfer / Migration -->
        <a href="/Deathregistration/DeathTransfer.aspx" class="service-card">
            <div class="service-icon">🏘️</div>
            <div>
