<%@ Page Title="Get Certified Copy" Language="C#" MasterPageFile="~/home.Master"
    AutoEventWireup="true" CodeBehind="CitizenshipCopy.aspx.cs" Inherits="HamroWard.CitizenshipRegistration.CitizenshipCopy" %>
...
<style>
    ...
    .upload-box { border:2.5px dashed var(--crimson); border-radius:16px; padding:1.6rem 1.2rem; text-align:center; cursor:pointer; transition:background 0.2s,border-color 0.2s; background:var(--crimson-light); }
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="custom-card">
                <div class="card-header-custom"><h5>Applicant Identity &nbsp;/&nbsp; निवेदकको परिचय</h5></div>
                <div class="card-body-custom row g-3">
                    <div class="col-md-6">
                        <label class="form-label">Full Name (Nepali) <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtNameNep" runat="server" CssClass="form-control" placeholder="पूरा नाम नेपालीमा" />
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Full Name (English) <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtNameEng" runat="server" CssClass="form-control" placeholder="Full Name in English" />
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Existing Citizenship Number <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="txtMobile" runat="server" CssClass="form-control" placeholder="98XXXXXXXX" TextMode="Phone" />
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Number of Copies Required <span class="text-danger">*</span></label>
                    ...
                    <div class="col-12">
                        <label class="form-label">Purpose / प्रयोजन <span class="text-danger">*</span></label>
                        <asp:DropDownList ID="ddlPurpose" runat="server" CssClass="form-select">
                            ...
                            <asp:ListItem Text="Bank Account Opening" Value="Bank" />
                            <asp:ListItem Text="Property Registration" Value="Property" />
                            <asp:ListItem Text="Job Application" Value="Job" />
                            <asp:ListItem Text="Education / Scholarship" Value="Education" />
            ...
            <div class="custom-card">
                ...
                <div class="card-body-custom d-flex flex-column gap-3">
                    <div class="upload-box" onclick="document.getElementById('<%=fileOriginalCitizenship.ClientID%>').click();">
                        <i class="bi bi-card-heading fs-2"></i>
                        <div class="fw-bold mt-2">Original Citizenship Certificate (Copy) <span class="text-danger">*</span></div>
                        <small class="text-muted">मूल नागरिकताको प्रतिलिपि (PDF/JPG, Max 2MB)</small>
                        <asp:FileUpload ID="fileOriginalCitizenship" runat="server" CssClass="d-none" />
                    </div>
                    ...
                    <div class="upload-box" onclick="document.getElementById('<%=fileApplication.ClientID%>').click();">
                        <i class="bi bi-file-earmark-text fs-2"></i>
                        <div class="fw-bold mt-2">Application Letter / निवेदन <span class="text-danger">*</span></div>
                        <small class="text-muted">हातले लेखेको निवेदन वा टाइप गरिएको (PDF/JPG)</small>
                        <asp:FileUpload ID="fileApplication" runat="server" CssClass="d-none" />
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="alert border-0 d-flex gap-3 p-4 mb-4"
                ...
                <p class="small mb-0">Certified copies are issued by the Ward Office and are valid for official use. Bring originals when collecting.</p></div>
            </div>
            <div class="custom-card">
                <div class="card-header-custom"><h5>Document Checklist</h5></div>
                <div class="card-body-custom">
                    <ul class="list-unstyled small mb-0">
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Original Citizenship (photocopy)</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Passport Size Photo</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Application Letter</li>
                    </ul>
                </div>
            </div>
            <div class="custom-card mt-3">
                ...
                <div class="card-body-custom">
                    <div class="d-flex justify-content-between mb-2 small"><span class="text-muted">Per Copy Fee</span><span class="fw-bold">Rs. 100</span></div>
