<%@ Page Title="Citizenship Transfer / Migration" Language="C#" MasterPageFile="~/home.Master"
    AutoEventWireup="true" CodeBehind="CitizenshipTransfer.aspx.cs" Inherits="HamroWard.CitizenshipRegistration.CitizenshipTransfer" %>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="custom-card">
                ...
                <div class="card-body-custom row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Migration Date / बसाइसराइ मिति <span class="text-danger">*</span></label>
                ...
                <div class="card-body-custom">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <asp:TextBox ID="txtOldDistrict" runat="server" CssClass="form-control" placeholder="Old District" />
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Municipality / VDC <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtOldMunicipality" runat="server" CssClass="form-control" placeholder="Old Municipality" />
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Ward No.</label>
                            <asp:TextBox ID="txtOldWard" runat="server" CssClass="form-control" placeholder="No." TextMode="Number" />
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Tole</label>
                            <asp:TextBox ID="txtOldTole" runat="server" CssClass="form-control" placeholder="Tole" />
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <label class="form-label">District <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtNewDistrict" runat="server" CssClass="form-control" placeholder="New District" />
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Municipality / VDC <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtNewMunicipality" runat="server" CssClass="form-control" placeholder="New Municipality" />
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Ward No. <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtNewWard" runat="server" CssClass="form-control" placeholder="No." TextMode="Number" />
                        </div>
                        <div class="col-md-2">
                            <label class="form-label">Tole <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtNewTole" runat="server" CssClass="form-control" placeholder="Tole" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="custom-card">
                ...
                <div class="card-body-custom d-flex flex-column gap-3">
                    <div class="upload-box" onclick="document.getElementById('<%=fileCitizenship.ClientID%>').click();">
                        <i class="bi bi-card-heading fs-2"></i>
                        <div class="fw-bold mt-2">Citizenship Certificate <span class="text-danger">*</span></div>
                        <small class="text-muted">नागरिकताको प्रतिलिपि (PDF/JPG)</small>
                        <asp:FileUpload ID="fileCitizenship" runat="server" CssClass="d-none" />
                    </div>
                    <div class="upload-box" onclick="document.getElementById('<%=fileMigrationCert.ClientID%>').click();">
                        <i class="bi bi-geo-alt fs-2"></i>
                        <div class="fw-bold mt-2">Migration Certificate (Basai Sarai Praman Patra) <span class="text-danger">*</span></div>
                    ...
                    <div class="upload-box" onclick="document.getElementById('<%=fileRelationCert.ClientID%>').click();">
                        <i class="bi bi-people fs-2"></i>
                        <div class="fw-bold mt-2">Relationship Certificate (नाता प्रमाण पत्र)</div>
                        <small class="text-muted">Family members migrating together (PDF/JPG)</small>
                        <asp:FileUpload ID="fileRelationCert" runat="server" CssClass="d-none" />
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <div class="alert border-0 d-flex gap-3 p-4 mb-4"
                ...
                <p class="small mb-0">Migration Certificate (Basai Sarai) must be obtained from your previous ward before submitting this application.</p></div>
            </div>
            <div class="custom-card">
                ...
                <div class="card-body-custom">
                    <ul class="list-unstyled small mb-0">
                        ...
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Migration Certificate (Basai Sarai)</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Passport Size Photo</li>
                        <li class="mb-2 text-muted"><i class="bi bi-circle me-2"></i>Relationship Certificate (if family)</li>
                    </ul>
                </div>
            </div>
            <div class="custom-card mt-3">
                ...
                <div class="card-body-custom">
                    <div class="d-flex justify-content-between mb-2 small"><span class="text-muted">Service Fee</span><span class="fw-bold">Rs. 300</span></div>
                    ...
                    <div class="fee-total d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold fs-5" style="color:var(--crimson);">Rs. 310</span>
                    </div>
                </div>
            </div>
        </div>
