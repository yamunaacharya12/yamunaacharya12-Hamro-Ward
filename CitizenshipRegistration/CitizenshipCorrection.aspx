<%@ Page Title="Citizenship Correction" Language="C#" MasterPageFile="~/home.Master"
    AutoEventWireup="true" CodeBehind="CitizenshipCorrection.aspx.cs" Inherits="HamroWard.CitizenshipRegistration.CitizenshipCorrection" %>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="custom-card">
                <div class="card-header-custom"><h5>Current Citizenship Details &nbsp;/&nbsp; हालको नागरिकता विवरण</h5></div>
                <div class="card-body-custom row g-3">
                    <div class="col-md-6">
                        <label class="form-label">Current Full Name (Nepali) <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtCurrentNameNep" runat="server" CssClass="form-control" placeholder="हालको पूरा नाम" />
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Current Full Name (English) <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtCurrentNameEng" runat="server" CssClass="form-control" placeholder="Current Full Name" />
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Citizenship Number <span class="text-danger">*</span></label>
                        <asp:TextBox ID="txtCitizenshipNo" runat="server" CssClass="form-control" placeholder="e.g. 12-01-75-12345" />
                    </div>
                    <div class="col-md-6">
            ...
            <div class="custom-card">
                ...
                <div class="card-body-custom">
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <div class="form-check">
                                <asp:CheckBox ID="chkName" runat="server" CssClass="form-check-input" />
                                <label class="form-check-label" for="<%=chkName.ClientID%>">Name Spelling / नाम हिज्जे</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                <asp:CheckBox ID="chkDOB" runat="server" CssClass="form-check-input" />
                                <label class="form-check-label" for="<%=chkDOB.ClientID%>">Date of Birth / जन्म मिति</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                <asp:CheckBox ID="chkAddress" runat="server" CssClass="form-check-input" />
                                <label class="form-check-label" for="<%=chkAddress.ClientID%>">Address / ठेगाना</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                <asp:CheckBox ID="chkParentName" runat="server" CssClass="form-check-input" />
                                <label class="form-check-label" for="<%=chkParentName.ClientID%>">Parent Name / अभिभावकको नाम</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                <asp:CheckBox ID="chkGender" runat="server" CssClass="form-check-input" />
                                <label class="form-check-label" for="<%=chkGender.ClientID%>">Gender / लिङ्ग</label>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-check">
                                <asp:CheckBox ID="chkOther" runat="server" CssClass="form-check-input" />
                                <label class="form-check-label" for="<%=chkOther.ClientID%>">Other / अन्य</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-2">
                        <label class="form-label">Additional Notes / थप विवरण</label>
            ...
            <div class="custom-card">
                ...
                <div class="card-body-custom d-flex flex-column gap-3">
                    <div class="upload-box" onclick="document.getElementById('<%=fileCurrentCitizenship.ClientID%>').click();">
                        <i class="bi bi-card-heading fs-2"></i>
                        <div class="fw-bold mt-2">Current Citizenship Certificate <span class="text-danger">*</span></div>
                        <small class="text-muted">हालको नागरिकताको प्रतिलिपि (PDF/JPG)</small>
                        <asp:FileUpload ID="fileCurrentCitizenship" runat="server" CssClass="d-none" />
                    </div>
                    <div class="upload-box" onclick="document.getElementById('<%=fileSupportingDoc.ClientID%>').click();">
                        ...
                        <div class="fw-bold mt-2">Supporting Document for Correction <span class="text-danger">*</span></div>
                        <small class="text-muted">सच्याउन प्रमाण: SLC certificate, Birth Certificate, etc. (PDF/JPG)</small>
        ...
        <div class="col-lg-4">
            <div class="alert border-0 d-flex gap-3 p-4 mb-4"
                ...
                <p class="small mb-0">Supporting documents (e.g. SLC certificate, birth certificate) must clearly show the correct information being requested.</p></div>
            </div>
            <div class="custom-card">
                <div class="card-header-custom"><h5>Document Checklist</h5></div>
                <div class="card-body-custom">
                    <ul class="list-unstyled small mb-0">
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Current Citizenship Certificate</li>
                        <li class="mb-2"><i class="bi bi-check-circle-fill me-2" style="color:var(--crimson);"></i>Proof of Correct Detail (SLC/Birth Cert)</li>
            ...
            <div class="custom-card mt-3">
                ...
                <div class="card-body-custom">
                    <div class="d-flex justify-content-between mb-2 small"><span class="text-muted">Correction Fee</span><span class="fw-bold">Rs. 200</span></div>
                    ...
                    <div class="fee-total d-flex justify-content-between align-items-center">
                        ...
                        <span class="fw-bold fs-5" style="color:var(--crimson);">Rs. 210</span>
                    </div>
                </div>
            </div>
        </div>
